...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb Funcoin Wallet (o Mist, Geth, Parity i altres clients de carteres.) ',
...
ADD_Ledger_0a               : 'Has d\'accedir a Funcoin Wallet utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir Funcoin Wallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir Funcoin Wallet utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir Funcoin Wallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb Funcoin Wallet CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant MyEtherWallet. Pots [descarregar-te el repo de Funcoin Wallet i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
