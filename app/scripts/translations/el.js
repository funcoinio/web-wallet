...
tx_notFound_4               : 'Παρακαλούμε χρησιμοποιήστε το αναπτυσσόμενο μενού πάνω δεξιά και επιλέξτε κάποιον διαφορετικό κόμβο ETHO (π.χ. `ETHO (Etherscan.io)` ή `ETHO (Infura.io)` ή `ETHO (MyEtherWallet)`) και ελέγξτε ξανά.',
...
tx_FoundOnChain_3           : '**Αν δεν βλέπετε σφάλματα, η συναλλαγή σας εστάλη επιτυχώς.** Τα ETHO σας ή οι μάρκες σας βρίσκονται εκεί που τα στείλατε. Αν δεν μπορείτε να δείτε αυτά τα ETHO ή τις μάρκες να έχουν πιστωθεί στο άλλο σας πορτοφόλι ή στο λογαριασμό του ανταλλακτηρίου σας, και έχουν περάσει 24+ ώρες από τότε που τα στείλατε, παρακαλούμε [επικοινωνήστε με αυτήν την υπηρεσία](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Στείλτε τους το *σύνδεσμο* προς τη συναλλαγή σας και ζητήστε τους ευγενικά να ρίξουν μια ματιά στο θέμα σας.',
...
GEN_Help_12                 : 'Χρησιμοποιήστε το για να ξεκλειδώσετε το πορτοφόλι σας μέσω του Funcoin Wallet (ή μέσω του Mist, του Geth, του Parity και άλλων προγραμμάτων-πελατών πορτοφολιού.) ',
...
TXFEE_Desc                  : 'Το τέλος συναλλαγής πληρώνεται στους μεταλλωρύχους για να συμπεριλάβουν τη συναλλαγή σας σε ένα μπλοκ. Είναι το `όριο αερίου` * `τιμή αερίου`. [Μπορείτε να μετατρέψετε GWEI -> ETHO εδώ](https://wallet.ether1.org/helpers.html)',
...
SWAP_init_2                 : " με ", // "I want to swap my X ETHO for X BTC"
...
ADD_Ledger_0a               : 'Ξανα-ανοίξτε το Funcoin Wallet σε ασφαλή (SSL) σύνδεση ',
ADD_Ledger_0b               : 'Ξανα-ανοίξτε το Funcoin Wallet χρησιμοποιώντας το [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-open Funcoin Wallet on a secure (SSL) connection ',
ADD_DigitalBitbox_0b        : 'Re-open Funcoin Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_17                    : 'Ο λογαριασμός από τον οποίο στέλνετε δεν έχει αρκετά κεφάλαια. Εάν στέλνετε μάρκες, πρέπει να έχετε 0.01 ETHO στο λογαριασμό σας για να καλύψετε το κόστος του αερίου. ', // 17
...
HELP_8_Desc_1               : 'Το Funcoin Wallet δεν είναι πορτοφόλι ιστού. Δεν γίνεται σύνδεση χρήστη και τίποτα δεν αποθηκεύεται στους διακομιστές μας. Είναι απλά μια διεπαφή που σας επιτρέπει να αλληλεπιδράσετε με το blockchain. ',
HELP_8_Desc_2               : 'Αν το Funcoin Wallet πέσει, μπορείτε να χρησιμοποιήσετε κάποιον άλλον τρόπο (όπως το geth ή το Ethereum Wallet / Mist) για να κάνετε ό,τι κάνουμε. Αλλά δεν θα χρειαστεί να «βγάλετε» τον Αιθέρα σας από το Funcoin Wallet επειδή δεν βρίσκεται μέσα στο MyEtherWallet. Βρίσκεται στο όποιο πορτοφόλι δημιουργήσατε μέσω του ιστοτόπου μας. ',
...
HELP_8_Desc_4               : 'Επιπρόσθετα, η πιθανότητα να πέσει το Funcoin Wallet είναι ελάχιστη έως ανύπαρκτη. Δεν μας κοστίζει σχεδόν τίποτα να το διατηρούμε, δεδομένου ότι δεν αποθηκεύουμε καμία πληροφορία. Εάν πάψει να λειτουργεί το όνομα χώρου, το Funcoin Wallet εξακολουθεί να είναι και πάντα θα είναι διαθέσιμο δημοσίως στη διεύθυνση [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Μπορείτε να κατεβάσετε το ZIP και να το εκτελέσετε τοπικά. ',
...
HELP_14_Title               : '14) Ορισμένοι ιστότοποι τυχαιοποιούν την παραγωγή του ιδιωτικού κλειδιού μέσω κινήσεων του ποντικιού. Το Funcoin Wallet δεν το κάνει αυτό. Είναι ασφαλής η παραγωγή τυχαίων αριθμών για το MyEtherWallet; ',
HELP_14_Desc_1              : 'Ενώ αυτό το πράγμα με τις κινήσεις του ποντικιού είναι έξυπνο και καταλαβαίνουμε γιατί αρέσει στους περισσότερους ανθρώπους, η πραγματικότητα όμως είναι ότι το window.crypto εξασφαλίζει περισσότερη εντροπία από τις κινήσεις του ποντικιού σας. Δεν είναι ότι οι κινήσεις του ποντικιού δεν είναι ασφαλείς, είναι ότι εμείς (και οι τόνοι πειραμάτων κρυπτογράφησης) πιστεύουμε στο window.crypto. Επιπλέον, το Funcoin Wallet μπορεί να χρησιμοποιηθεί σε συσκευές αφής. Εδώ είναι μια [συζήτηση μεταξύ ενός θυμωμένου redditor και του Vitalik Buterin σχετικά με τις κινήσεις του ποντικιού έναντι του window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) και εδώ είναι οι [προδιαγραφές w3 του window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
