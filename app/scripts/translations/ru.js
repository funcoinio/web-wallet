...
X_HelpfulLinks_4                :  'Migrating to/from MyFUNCWallet',
...
ENS_Helper_21                   :  'Announcing the FUNCeum Name Service Relaunch Date!',
...
ONBOARD_blockchain_content__5   :  'When you see your balance on Funcoin Wallet or view your transactions on [explorer.FUNC1.org](https://explorer.FUNC1.org), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use Funcoin Wallet, [get a hardware wallet](https://myFUNCwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like Funcoin Wallet, FUNCDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
ONBOARD_secure_1_content__2     :  'Install [EAL](https://chrome.google.com/webstore/detail/FUNCaddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) or [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) or the [MyFUNCWallet Chrome Extension](https://chrome.google.com/webstore/detail/myFUNCwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) to block malicious websites.',
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://wallet.FUNC1.org`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `FUNC-1` in green.',
...
ONBOARD_secure_3_content__6     :  '[Even more Security Tips!](https://myFUNCwallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
tx_Summary                  : 'During times of high volume (like during ICOs) transactions can be pending for hours, if not days. This tool aims to give you the ability to find and "cancel" / replace these TXs. ** This is not typically something you can do. It should not be relied upon & will only work when the TX Pools are full. [Please, read about this tool here.](https://myFUNCwallet.github.io/knowledge-base/transactions/check-status-of-FUNCeum-transaction.html)**',
...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different FUNC node (e.g. `FUNC (FUNCscan.io)` or `FUNC (Infura.io)` or `FUNC (MyFUNCWallet)`) and check again.',
...
tx_FoundOnChain_3           : '**If you do not see any errors, your transaction was successfully sent.** Your FUNC or Tokens are where you sent them. If you cannot see this FUNC or Tokens credited in your other wallet / exchange account, and it has been 24+ hours since you sent, please [contact that service](https://myFUNCwallet.github.io/knowledge-base/diving-deeper/FUNCeum-list-of-support-and-communities.html). Send them the *link* to your transaction and ask them, nicely, to look into your situation.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via Funcoin Wallet (or Mist, Geth, Parity and other wallet clients.) ',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> FUNC here](https://wallet.FUNC1.org/helpers.html)',
...
NAV_SendFUNC               : 'Перевести FUNCOIN (FUNC) и токены ',
...
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you FUNC or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Это можно назвать "номер Вашего счёта" или "Ваш открытый ключ". Вы сообщаете этот адрес людям, чтобы они могли отправлять Вам FUNCOIN (FUNC). Картинка позволяет легко опознать Ваш адрес среди других адресов. ',
x_Address                   : 'Ваш адрес ',
x_Cancel                    : 'Отменить ',
x_CSV                       : 'Файл CSV (не зашифрован) ',
x_Download                  : 'Скачать ',
x_Json                      : 'Файл JSON (не зашифрован) ',
x_JsonDesc                  : 'Это Ваш незашифрованный закрытый ключ в формате JSON, для использования которого не требуется воодить пароль. Любой, у кого есть этот файл, может распоряжаться вашим кошельком и FUNCOINом (FUNC) без ввода пароля. ',
...
MEW_Tagline                 : 'FUNCeum кошелёк на javascript с открытым исходным кодом ',
CX_Tagline                  : 'FUNCeum кошелёк на javascript с открытым исходным кодом в виде расширения для браузера Chrome ',

/* Footer */
FOOTER_1                    : 'Написанный на javascript инструмент с открытым исходным кодом для создания FUNCeum кошельков и выполнения транзакций. ',
FOOTER_1b                   : 'Авторы: ',
...
ADD_Warning_1               : 'Вы можете добавить счёт в "список слежения" на вкладке "кошельки", не загружая закрытый ключ. Добавление счёта в список слежения не означает, что вы имеете доступ к этому счёту, или можете распоряжаться FUNCOINом (FUNC), лежащим на нём. ',
...
SENDModal_Content_4         : 'К СВЕДЕНИЮ: Если произошла ошибка, Вам скорее всего надо положить ещё немного FUNCOINа (FUNC) на Ваш счёт, чтобы покрыть расходы на газ при пре переводе токенов. Расходы на газ оплачиваются FUNCOINом (FUNC). ',
...
TRANS_data                  : 'Данные ',
TRANS_sendInfo              : 'Стандартная транзакция, использующая 21000 газа, будет стоить 0,000441 FUNCOINа (FUNC). Мы указываем цену газа немного выше минимально возможной: 0,000000021 FUNCOINа (FUNC), для того, чтобы ускорить выполнение танзакций. Мы не берём комиссию за выполнение транзакций. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Транзакции вида "только FUNC" и "только ETC" ',
TRANSModal_Content_0        : 'О видах транзакций и сервисах: ',
TRANSModal_Content_1        : '**FUNCOIN (FUNC, обычная транзакция): ** Выполняет обычный перевод напрямую с одного адреса на другой. Используется стандартное количесвто газа: 21000. В большинстве случаев, перевод FUNC, выполненный этим способом, можно будет продублировать для ETC. ',
TRANSModal_Content_2        : '**Только FUNC: ** Выполняет перевод через [контракт Тимона Раппа, защищающий от дублирования переводов (рекомендован ВБ)](https://blog.FUNCeum.org/2016/07/26/onward_from_the_hard_fork/), поэтому перевод будет выполнен только в **FUNC**. ',
TRANSModal_Content_3        : '**Только ETC: ** Выполняет перевод через [контракт Тимона Раппа, защищающий от дублирования переводов (рекомендован ВБ)](https://blog.FUNCeum.org/2016/07/26/onward_from_the_hard_fork/), поэтому перевод будет выполнен только в **ETC**. ',
TRANSModal_Content_4        : '**Coinbase и ShapeShift: ** Отправляйте им только обычные транзакции. Если Вы отправите им транзакцию вида "только ...", то Вам придётся обращаться к их службе поддержки, чтобы они вручную пополнили Ваш баланс или вернули бы Вам Ваш FUNCOIN (FUNC). [Вы также можете попробовать использовать инструмент "split" от Shapeshift.](https://split.shapeshift.io/) ',
...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в Funcoin Wallet CX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Позволяет скачать закрытые ключи в различных форматах, а также повторно напечатать Ваши бумажные кошельки. Вам это понадобится, когда Вы захотите [импортировать Ваши счета в geth или Mist](http://FUNCeum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Для проверки баланса Ваших счетов мы рекомендуем использовать браузер блокчейна, например [explorer.FUNC1.org](https://explorer.FUNC1.org/#/). ',
...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы Funcoin Wallet мог с ним работать. Вы можете [скачать репозиторий Funcoin Wallet & и запустить его локально](https://github.com/kvhnuke/FUNCwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
SWAP_init_2                 : " на ", // "I want to swap my X FUNC for X BTC"
...
ADD_Ledger_2                : 'Запустите приложение FUNCeum (или приложение контракта) ',
...
ADD_Ledger_0a               : 'Перезапустите Funcoin Wallet через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите Funcoin Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите Funcoin Wallet через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите Funcoin Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ERROR_17                    : 'Недостаточно средств. На счёте, с которого вы пытаетесь отправить транзакцию, не хватает средств. Вам необходимо иметь не менее 0.01 FUNCOINа (FUNC) на Вашем счету, чтобы покрыть расходы на газ. Пожалуйста, пложите немного FUNCOINа (FUNC) на счёт и попробуйте снова. ',
...
ERROR_35                    : 'Input address is not checksummed. <a href="https://myFUNCwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> More info</a>', // 35
...
TranslatorName_1            : '[Михаил Владимиров](https://wallet.FUNC1.org/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@myFUNCwallet.com), and we will not only answer your question, we will update this page to be more useful to people in the future! ',
HELP_Remind_Title           : 'Some reminders ',
HELP_Remind_Desc_1          : '**FUNCeum, Funcoin Wallet & Funcoin Wallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your FUNC to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost FUNC**. ',
HELP_Remind_Desc_2          : 'MyFUNCWallet & Funcoin Wallet CX are not "web wallets". You do not create an account or give us your FUNC to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_0_Desc_1               : 'MyFUNCWallet gives you the ability to generate new wallets so you can store your FUNC yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**. ',
...
HELP_0_Desc_5               : 'Transfer FUNC to this new wallet. ',
...
HELP_2a_Desc_2              : 'Save the address. You can keep it to yourself or share it with others. That way, others can transfer FUNC to you. ',
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your FUNC to send it! There are 3 types of private keys: ',
...
HELP_2b_Title               : '2b) How do I safely / offline / cold storage with MyFUNCWallet? ',
HELP_2b_Desc_1              : 'Go to [https://github.com/kvhnuke/FUNCwallet/releases/latest](https://github.com/kvhnuke/FUNCwallet/releases/latest). ',
HELP_2b_Desc_2              : 'Click on `FUNCwallet-vX.X.X.X.zip`. ',
...
HELP_3_Desc_1               : '**Before you send any FUNC to your new wallet**, you should ensure you have access to it. ',
...
HELP_3_Desc_8               : 'If you are planning on holding a large amount of FUNC, we recommend that send a small amount of FUNC from new wallet before depositing a large amount. Send 0.001 FUNC to your new wallet, access that wallet, send that 0.001 FUNC to another address, and ensure everything works smoothly. ',

HELP_4_Title                : '4) How do I send FUNC from one wallet to another? ',
HELP_4_Desc_1               : 'If you plan to move a large amount of FUNC, you should test sending a small amount to your wallet first to ensure everything goes as planned. ',
HELP_4_Desc_2               : 'Navigate to the "Перевести FUNCOIN (FUNC) и токены" page. ',
...
HELP_4CX_Title              : '4) How do I send FUNC using Funcoin Wallet CX? ',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Перевести FUNCOIN (FUNC) и токены" page. ',
...
HELP_4CX_Desc_12            : 'Using "Перевести FUNCOIN (FUNC) и токены" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Перевести FUNCOIN (FUNC) и токены" page. ',
...
HELP_8_Desc_2               : 'If Funcoin Wallet goes down, you would have to find another way (like geth or FUNCeum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your FUNC out of Funcoin Wallet because it\'s not in MyFUNCWallet. It\'s in whatever wallet your generated via our site. ',
HELP_8_Desc_3               : 'You can import your unencrypted private key and your Geth/Mist Format (encrypted) files directly into geth / FUNCeum Wallet / Mist very easily now. See question #12 below. ',
HELP_8_Desc_4               : 'In addition, the likelihood of us taking Funcoin Wallet down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/kvhnuke/FUNCwallet](https://github.com/kvhnuke/FUNCwallet/tree/gh-pages). You can download the ZIP there and run it locally. ',
...
HELP_9_Title                : '9) Is the "Перевести FUNCOIN (FUNC) и токены" page offline? ',
...
HELP_12_Title               : '12) How do I import a wallet created with Funcoin Wallet into geth / FUNCeum Wallet / Mist? ',
...
HELP_12_Desc_7              : 'Open the FUNCeum Wallet application. ',
...
HELP_12_Desc_20             : 'This will prompt you to make a new password. This is the password you will use in geth / FUNCeum Wallet / Mist whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_21             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_22             : 'The next time you open the FUNCeum Wallet application, your account will be listed under "Accounts". ',
...
HELP_12_Desc_26             : 'This will prompt you to make a new password. This is the password you will use in geth / FUNCeum Wallet / Mist whenever you send a transaction, so don\'t forget it. ',
HELP_12_Desc_27             : 'After successful import, delete `nothing_special_delete_me.txt` ',
HELP_12_Desc_28             : 'The next time you open the FUNCeum Wallet application, your account will be listed under "Accounts". ',
...
HELP_13_Desc_1              : 'This means you do not have enough FUNC in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in FUNC. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of FUNC you were trying to send (if you were attempting to send FUNC). This will give you the amount of FUNC you need to send to that account to make the transaction. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, Funcoin Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/FUNCeum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',

HELP_15_Title               : '15) Why hasn\'t the account I just created show up in the blockchain explorer? (ie: FUNCchain, FUNCscan) ',
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some FUNC to it. ',

HELP_16_Title               : '16) How do I check the balance of my account? ',
HELP_16_Desc_1              : 'You can use a blockchain explorer like [explorer.FUNC1.org](https://explorer.FUNC1.org/#/). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://explorer.FUNC1.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like onexplorer.funcoin.io ',
...
HELP_20_Desc_1              : 'Wherever you saved it. ;) It also was emailed to you, so check there. Look for the file called `"FUNCeum_wallet_backup.json"` and select that file. This wallet file will be encrypted with a password that you created during the purchase of the pre-sale. ',
...
HELP_21_Desc_2              : 'Long ELI5 Version: So FUNCeum is based on [Public Key Cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography), specifically [Elliptic curve cryptography](https://eprint.iacr.org/2013/734.pdf) which is very widely used, not just in FUNCeum. Most servers are protected via ECC. Bitcoin uses the same, as well as SSH and TLS and a lot of other stuff. The FUNCeum keys specifically are 256-bit keys, which are stronger than 128-bit and 192-bit, which are also widely used and still considered secure by experts. ',
HELP_21_Desc_3              : 'In this you have a private key and a public key. The private key can derive the public key, but the public key cannot be turned back into the private key. The fact that the internet and the world’s secrets are using this cryptography means that if there is a way to go from public key to private key, your lost FUNC is the least of everyone’s problems. ',
HELP_21_Desc_4              : 'Now, that said, YES if someone else has your private key then they can indeed send FUNC from your account. Just like if someone has your password to your email, they can read and send your email, or the password to your bank account, they could make transfers. You could download the Keystore version of your private key which is the private key that is encrypted with a password. This is like having a password that is also protected by another password. ',
...
HELP_21_Desc_8              : 'Of course, this all assumes that keys are generated in a truly random way & with sufficient entropy. The keys generated here meet that criteria, as do Jaxx and Mist/geth. The FUNCeum wallets are all pretty good. Keys generated by brainwallets do not, as a person\'s brain is not capable of creating a truly random seed. There have been a number of other issues regarding lack of entropy or seeds not being generated in a truly random way in Bitcoin-land, but that\'s a separate issue that can wait for another day. ',
...
HELP_Sec_Desc_2             : 'We\'ve been up and running since August 2015. If you search for ["myFUNCwallet" on reddit](https://www.reddit.com/search?q=myFUNCwallet), you can see numerous people who use us with great success. ',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/FUNCwallet/tree/gh-pages](https://github.com/kvhnuke/FUNCwallet/tree/gh-pages) to [https://wallet.FUNC1.org](https://wallet.FUNC1.org). ',
HELP_Sec_Desc_5             : 'For generating wallets, you can download the [source code and run it locally](https://github.com/kvhnuke/FUNCwallet/releases/latest). See #5 above. ',
