...
ENS_Helper_4                    :  'Tentukan jumlah maksimum ETHO yang bersedia Anda bayar untuk nama tersebut (<u>Bid Amount</u> Anda). Pastikan akun memiliki cukup dana untuk membayar tawaran Anda + 0.01 ETHO untuk gas.',
...
EOS_06                          :  'Buka halaman Send Funcoin & Tokens',
...
ONBOARD_welcome_content__6      :  'Funcoin Wallet memungkinkan Anda untuk berinteraksi langsung dengan blockchain sambil tetap memegang kendali penuh atas kunci &amp; dana Anda.',
...
ONBOARD_interface_content__1    :  'Saat membuat akun di Funcoin Wallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_interface_content__6    :  'Jika Anda mengirim *kunci publik (alamat)* kepada seseorang, mereka dapat mengirimkan ETHO atau token. 👍',
...
ONBOARD_bank_title__alt         :  'Funcoin Wallet bukan sebuah Bank',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari Funcoin Wallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di Funcoin Wallet atau melihat transaksi Anda di [explorer.ether1.org](https://explorer.ether1.org), Anda melihat data di blockchain, bukan di sistem privat Anda.',
ONBOARD_blockchain_content__6   :  'Sekali lagi: **kami bukan sebuah bank**.',
ONBOARD_interface_title__alt    :  'Funcoin Wallet adalah sebuah antarmuka',
...
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya Funcoin Wallet kalau begitu?',
ONBOARD_whymew_title            :  'Jika Funcoin Wallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan Funcoin Wallet, [gunakan dompet hardware](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti Funcoin Wallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
...
ONBOARD_final_content__3        :  'Cara Setup Funcoin Wallet + MetaMask',
ONBOARD_final_content__4        :  'Cara Menjalankan Funcoin Wallet Offline / Lokal',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETHO lainnya (e.g. `ETHO (Etherscan.io)` atau `ETHO (Infura.io)` atau `ETHO (MyEtherWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui Funcoin Wallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
ADD_Ledger_0a               : 'Buka kembali Funcoin Wallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali Funcoin Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali Funcoin Wallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali Funcoin Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan Funcoin Wallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui MyEtherWallet. Anda dapat [mengunduh Funcoin Wallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
SWAP_init_2                 : " menjadi ", // "I want to swap my X ETHO for X BTC"
...
HELP_Remind_Desc_1          : '** Ethereum, Funcoin Wallet & Funcoin Wallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETHO Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet & Funcoin Wallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_3_Desc_3               : 'Buka laman Funcoin Wallet bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan Funcoin Wallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan Funcoin Wallet secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan Funcoin Wallet secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'MyEtherWallet sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari Funcoin Wallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui Funcoin Wallet, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_2               : 'Jika situs Funcoin Wallet tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari Funcoin Wallet karena Ether Anda tidak disimpan di MyEtherWallet. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan Funcoin Wallet CX. Dengan begitu, jika terjadi sesuatu pada Funcoin Wallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya Funcoin Wallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan Funcoin Wallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari Funcoin Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - Funcoin Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan Funcoin Wallet, bukan Chrome Extension ini. ',
