...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETHO différent (par ex. `ETHO (Etherscan.io)` ou `ETHO (Infura.io)` ou `ETHO (MyEtherWallet)`) et revérifiez.',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos ETHO ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces ETHO ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec Funcoin Wallet (ou Mist, Geth, Parity et autres wallet clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> ETHO ici](https://wallet.ether1.org/helpers.html)',
...
ADD_Ledger_0a               : 'Please use Funcoin Wallet on a secure (SSL / HTTPS) connection to connect. ',
ADD_Ledger_0b               : 'Re-open Funcoin Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK Funcoin Wallet CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
...
SWAP_init_2                 : 'POU ', //M’ VLE CHANJE X ETHO POU X BTC '
...
SWAP_progress_3             : ', // ETHO Received! ETHO RESEVWA ! ',
SWAP_progress_4             : 'VOYE {{REZILTA LÒD. KREYASYON.MONNEN}} YO ',
SWAP_progress_5             : 'LÒD AKONPLI ',
SWAP_order_CTA              : 'TANPRI VOYE 1 ETHO ',
SWAP_unlock                 : 'OUVRI BOUS OU A POU W’ VOYE ETHO YO OSWA TOKENS YO SÒTI DIRÈKTEMAN NAN SA ',
...
HELP_8_Desc_2               : 'SI MYETHERWALLET.COM TONBE, OU DWE JWENN YON LÒT MWAYEN ( TANKOU GETHO OSWA ETHEREUM WALLET / MIST) POU FÈ MENM BAGAY LA. MEN OU PA GEN POU "REPRAN " ETHER W’ LA KI NAN MY ETHERWALLET PASKE L’ PA NAN MY ETHERWALLET. LI LAKAY OU. NAN BOUS SA W’ TE KREYE SOU SIT NOU AN. ',
...
HELP_12_Desc_19             : 'OUVRI YON PÒ EPI KÒMANSE KOMAND KI VINI AN : `GETHO ACCOUNT  IMPORT~/DESKTOP/NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_20             : 'SA AP ENVITE CHWAZI YON NOUVO KÒD SEKRÈ. SE SA W’ PRAL ITILIZE NAN GETHO / ETHEREUM WALLET / MIST  NAN CHAK MOMAN OU PRAL FÈ YON TRANSFÈ. KIDONK PA BLIYE L’. ',
...
HELP_12_Desc_25             : 'KÒMANSE AK KÒMAND  `GETHO ACCOUNT IMPORT C:// NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_26             : 'SA PRAL ENVITE W’ POU CHWAZI YON NOUVO KÒD SEKRÈ. SE AK SA W’ PRAL SÈVI NA GETHO / ETHEREUM WALLET / MIST CHAK FWA OU PRAL VOYE YON TRANFÈ KIDONK PA BLIYE L’. ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK Funcoin Wallet KE EXTENSION CHROME SA. ',
