...
ONBOARD_bank_title__alt         :  'Funcoin Wallet 不是银行',
...
ONBOARD_blockchain_content__5   :  '当你使用 Funcoin Wallet 查看余额, 或者使用 [explorer.ether1.org](https://explorer.ether1.org)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **MyEtherWallet不是银行**.',
ONBOARD_interface_title__alt    :  'Funcoin Wallet 只是操作接口',
...
ONBOARD_whymew_content__6       :  '如果你担心 Funcoin Wallet 还不够安全, [那就赶紧买个硬件钱包吧](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
...
ONBOARD_final_content__3        :  '如何安装 Funcoin Wallet + MetaMask',
...
TRANSModal_Content_2        : '**只发送：FUNC：** 这是通过[Timon Rapp的重放保护合约（VB推荐）](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/)， 所以你只会在ETH链上发送交易。 ',
