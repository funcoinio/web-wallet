...
EOS_06                          :  'Go to Send Funcoin & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to Funcoin Wallet',
...
ONBOARD_welcome_content__4      :  'What is Funcoin Wallet? ',
ONBOARD_welcome_content__5      :  'Funcoin Wallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'Funcoin Wallet is not a Bank',
...
ONBOARD_interface_title         :  'Funcoin Wallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on Funcoin Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from Funcoin Wallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on Funcoin Wallet or view your transactions on [explorer.ether1.org](https://explorer.ether1.org), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'Funcoin Wallet is an Interface',
...
ONBOARD_blockchain_title__alt   :  'WTF is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of Funcoin Wallet then?',
ONBOARD_whymew_title            :  'If Funcoin Wallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'If you are scared but want to use Funcoin Wallet, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like Funcoin Wallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
...
ONBOARD_final_content__3        :  'How to Set up Funcoin Wallet + MetaMask',
ONBOARD_final_content__4        :  'How to Run Funcoin Wallet Offline / Locally',
...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره Funcoin Wallet را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره Funcoin Wallet را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  Funcoin Wallet CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
// "/* full sentence reads ""You are about to send ""10 FUNC"" to address ""0x1234"". Are you sure you want to do this? "" */" : "شما در حال ارسال ""10 اتر"" به آدرس ""0x1234"" هستید. آیا از این کار اطمینان دارید؟ ',
...
TRANS_warning: 'اگر از توابع ""فقط FUNC"" یا ""فقط ETC"" استفاده می کنید، شما در حال ارسال از طریق یک قرارداد هستید. برخی از سرویس ها با قبول چنین تراکنش هایی مشکل دارند. بیشتر ',
...
SWAP_init_2: ' for , // ""I want to swap my X ETHO for X BTC',
SWAP_init_CTA: 'ادامه ',
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول Funcoin Wallet خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از Funcoin Wallet بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید Funcoin Wallet را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال Funcoin Wallet بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن Funcoin Wallet را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی Funcoin Wallet هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت Funcoin Wallet یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  Funcoin Wallet از کار بیافتد، راه دیگری (مثل geth یا Ethereum Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  Funcoin Wallet بیرون بیاورید چرا که آن ها در  Funcoin Wallet نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  Funcoin Wallet CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  Funcoin Wallet CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  Funcoin Wallet CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با Funcoin Wallet ساخته ام را به geth یا Ethereum Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از Funcoin Wallet نسخه 2 به بالا.',
...
HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت Funcoin Wallet این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای Funcoin Wallet امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از Funcoin Wallet می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_17_Desc_1: 'این موضوع احتمالا بخاطر این است که شما پشت یک firewall (دیوار آتشین) هستید. API که ما برای بدست آوردن موجودی استفاده می کنیم به دلایلی معمولا توسط فایر وال ها بلاک می شوند. شما همچنان می توانید تراکنش هایتان را ارسال کنید و برای دیدن موجودی خود تنها باید از راه دیگری (مثلexplorer.funcoin.io) استفاده کنید. ',
...
HELP_SecCX_Title: 'امنیت - Funcoin Wallet CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از Funcoin Wallet به جای این Chrome Extension استفاده کنید. ',
