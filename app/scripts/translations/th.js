...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน Funcoin Wallet (หรือ Mist, Geth, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ Funcoin Wallet ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด Funcoin Wallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด Funcoin Wallet อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด Funcoin Wallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ Funcoin Wallet CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
SWAP_order_CTA              : "กรุณาส่ง ", // Please send 1 FUNC...
