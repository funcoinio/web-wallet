...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud ETHO différent (par ex. `ETHO (Etherscan.io)`, `ETHO (Infura.io)` ou `ETHO (MyEtherWallet)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec Funcoin Wallet (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETHO ici.](https://wallet.ether1.org/helpers.html)',
...
TRANS_warning               : 'L\'emploi des fonctions "ETHO seulement" et "ETC seulement" vous fait passer par un contrat. Certains services ont des problèmes avec ces transactions. En savoir plus.',
TRANS_advanced              : '+ Avancé : Ajouter des données',
TRANS_data                  : 'Données',
TRANS_sendInfo              : 'Une transaction standard utilisant 21000 GAS coûtera 0,000441 FUNC. Le prix du GAS, de 0.000000021 FUNC, que nous avons choisi est légèrement supérieur au minimum assurant une confirmation rapide. Nous ne prenons pas de frais de transaction.',
TRANS_gas                   : 'GAS limite', // changed in ENG to Gas Limit:

/* Send Transaction Modals */
TRANSModal_Title            : 'Transactions "ETHO seulement" et "ETC seulement"',
TRANSModal_Content_0        : 'Note sur les transactions et services divers :',
TRANSModal_Content_1        : '**ETHO (Transaction standard) :** Génère une transaction standard depuis une adresse directement vers une autre. Son GAS par défaut est de 21000. Il est probable que toute transaction d\'ETHO envoyée de cette manière sera réexécutée sur la chaîne ETC.',
TRANSModal_Content_2        : '**ETHO seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **FUNC**.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec Funcoin Wallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
ADD_Ledger_0a               : 'Rouvrir Funcoin Wallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir Funcoin Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir Funcoin Wallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir Funcoin Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
SWAP_init_2                 : " contre", // "I want to swap my X ETHO for X BTC"
...
SWAP_progress_3             : "reçu !", // ETHO Received!
SWAP_progress_4             : "Envoi de vos {{orderResult.output.currency}}",
SWAP_progress_5             : "Ordre exécuté",
SWAP_order_CTA              : "Envoyer ", // Please send 1 FUNC...
SWAP_unlock                 : "Déverrouillez votre portefeuille pour envoyer des ETHO ou des tokens directement depuis cette page.",
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec Funcoin Wallet ?',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec Funcoin Wallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer Funcoin Wallet hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer Funcoin Wallet sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyEtherWallet tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo Funcoin Wallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment Funcoin Wallet, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_2               : 'Si Funcoin Wallet venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis Funcoin Wallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par Funcoin Wallet CX. De cette manière, si quoi que ce soit arrivait à Funcoin Wallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, Funcoin Wallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par Funcoin Wallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de Funcoin Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Sécurité - Funcoin Wallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser Funcoin Wallet au lieu de cette extension Chrome.',
