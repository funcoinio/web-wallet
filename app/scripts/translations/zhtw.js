...
ONBOARD_interface_content__1    :  '當你在 Funcoin Wallet 建立一個帳戶，你是在產生一串密碼數列：你的私鑰和你的公鑰 (地址)。',
...
GEN_Help_12                 : '用它在 Funcoin Wallet (或Mist、Geth、Parity和其他錢包) 來解鎖你的錢包 ',
...
NODE_Warning                : '你的節點必須使用HTTPS安全連線的方式才能夠由 Funcoin Wallet 連接到它。 你可以下載 [MyEtherWallet repo](https://github.com/kvhnuke/etherwallet/releases/latest) 並建立起一個你的節點來連接至其他的節點。或著從 [LetsEncrypt](https://letsencrypt.org/) 獲取免費的SSL憑證',
NODE_Name                   : '節點名稱',
NODE_Port                   : '節點連線的端口號碼',
