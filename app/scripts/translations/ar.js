...
sidebar_donation            : 'Funcoin Wallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us? ',
sidebar_donate              : 'تبرع ',
sidebar_thanks              : 'شكرا!!! ',
...
ADD_Ledger_0a               : 'You must access Funcoin Wallet via a secure(SSL / HTTPS) connection to connect.',
...
MYWAL_Content_3             : 'If you want to use this wallet with your Funcoin Wallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et de ré-imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.funcoin.io](https://explorer.funcoin.io/#/). ',
...
ADD_Ledger_0a               : 'Réouvrir Funcoin Wallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir Funcoin Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Connexion au TREZOR ',
ADD_Trezor_select           : 'Ceci est une _seed_ TREZOR ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Réouvrir Funcoin Wallet sur une connexion sécurisée (SSL) ',
ADD_DigitalBitbox_0b        : 'Réouvrir Funcoin Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
HELP_4_Desc_2               : 'Navigate to the "Send Funcoin & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send Funcoin & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send Funcoin & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send Funcoin & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Send Funcoin & Tokens" page offline? ',
