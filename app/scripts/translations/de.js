...
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `ETHO (Etherscan.io)` oder `ETHO (Infura.io)` oder `ETHO (MyEtherWallet)`) und prüfen es erneut.',
...
tx_FoundOnChain_3           : '**Wenn sie keine Fehlernachrichten bekommen, wurde ihre Transaktion erfolgreich versendet.** Ihre ETHO oder Tokens sind dort, wohin sie versendet wurden. Wenn Sie die ETHO or Tokens nicht im anderen Wallet / Exchange account sehen können, und es schon mehr als 24 Stunden her ist, seitdem Sie gesendet haben, bitte [Kontaktieren Sie den Service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Senden Sie den *link* zu ihrer Transaktion und fragen Sie höflich, die Situation anzuschauen.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei Funcoin Wallet (oder Mist, Geth, Parity und andere Wallet Clients.) zu öffnen ',
...
TXFEE_Desc                  : 'Die Transaktionsgebühr wird den Miner(n) bezahlt, die Ihre Transaktion in einen Block einschließen. Es wird durch `Gas-Limit` * `Gas-Preis` berechnet. [Du kannst GWEI -> ETHO hier umwandeln](https://wallet.ether1.org/helpers.html)',
...
MYWAL_Content_3             : 'Wenn Sie dieses Wallet in Zukunft mit Funcoin Wallet CX verwenden wollen, müssen Sie es mittels des privaten Schlüssels/JSON Datei und Ihrem Passwort manuell wieder hinzufügen. ',
...
SWAP_init_2                 : " gegen ", // "I want to swap my X ETHO for X BTC"
...
HELP_4CX_Title              : '4) Wie kann ich Ether über Funcoin Wallet CX senden? ',
...
HELP_5_Title                : '5) Wie kann ich Funcoin Wallet offline/lokal starten? ',
