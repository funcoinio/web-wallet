...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere ETHO node (bijvoobeeld `ETHO (Etherscan.io)` of `ETHO (Infura.io)` of `ETHO (MyEtherWallet)`) en check opnieuw.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via Funcoin Wallet (of Mist, Geth, Parity en andere wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limiet is de hoeveelheid gas waarmee je je TX verstuurd. `TX vergoeding = gas prijs * gas limiet` & wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. Het verhogen van dit nummer zorgt er niet voor dat je TX sneller ge-mined zal worden. Verzenden van ETHO = `21000`. Verzenden van Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETHO converteren](https://wallet.ether1.org/helpers.html)',
...
ADD_Ledger_0a               : 'Her-open Funcoin Wallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open Funcoin Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open Funcoin Wallet met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open Funcoin Wallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met Funcoin Wallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Een standaard transactie met 21000 gas zal 0.000441 ETHO kosten. Wij gebruiken een iets-boven-minimum gas prijs van 0.000000021 ETHO om te garranderen dat de transactie snel uitgevoerd zal worden. Wij zijn niet verantwoordelijk voor je transactie kosten. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met Funcoin Wallet te kunnen verbinden. Je kunt de [MyEtherWallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
SWAP_init_2                 : " omwisselen voor ", // "I want to swap my X ETHO for X BTC"
...
SWAP_progress_3             : "Ontvangen! ", // ETHO Received!
SWAP_progress_4             : "Verzenden van je {{orderResult.output.currency}} ",
SWAP_progress_5             : "Bestelling Voltooid ",
SWAP_order_CTA              : "Verzend alsjeblieft ", // Please send 1 FUNC...
SWAP_unlock                 : "Open je Wallet op deze pagina om ETHO of Tokens direct te verzenden. ",
...
HELP_2a_Desc_3              : 'Bewaar versies van je prive sleutel. Deel deze niet met anderen. Je prive sleutel heb je nodig wanneer je toegang tot je ETHO wilt om het te versturen! Er zijn drie soorten prive sleutels: ',
...
HELP_3_Desc_3               : 'Navigeer naar de Funcoin Wallet "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met Funcoin Wallet CX? ',
...
HELP_5_Title                : '5) Hoe voer ik Funcoin Wallet offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt Funcoin Wallet uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'MyEtherWallet draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de Funcoin Wallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we Funcoin Wallet continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'Funcoin Wallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als Funcoin Wallet er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit Funcoin Wallet halen omdat het niet in Funcoin Wallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_12_Title               : '12) Hoe importeer ik een Funcoin Wallet  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van Funcoin Wallet v2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. Funcoin Wallet doet dit niet. Is de wikkeleurigheid (random number generation) van Funcoin Wallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan Funcoin Wallet gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1              : 'Je kunt hiervoor een blockchain explorer gebruiken zoals bijvoorbeeld [explorer.ether1.org](https://explorer.ether1.org/#/). Plak daar je adres in de zoekbalk en je adres en transactie geschiedenis zullen worden getoond. Bekijk bijvoobeeld hoe ons [donatie account](https://explorer.ether1.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D)  eruit ziet opexplorer.funcoin.io ',

HELP_17_Title               : '17) Waarom wordt mijn saldo niet weergegeven nadat ik mijn wallet heb ontsleuteld? ',
HELP_17_Desc_1              : 'Dit wordt zeer waarschijnlijk veroorzaakt door het feit dat je achter een firwall zit. De API waarvan we gebruik maken om je saldo op te halen en te converteren wordt vaak geblokkeerd door firewalls om wat voor reden dan ook. Het is nog steeds mogelijk om transacties te verzenden, je hebt enkel een andere methode nodig om je saldo the checken, zoals bijvoorbeeldexplorer.funcoin.io ',
...
HELP_SecCX_Title            : 'Beveiliging - Funcoin Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van Funcoin Wallet in plaats van deze Chrome Extensie. ',
