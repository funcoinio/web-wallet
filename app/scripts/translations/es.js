...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo ETHO diferente (ej. `ETHO (Etherscan.io)` o `ETHO (Infura.io)` o `ETHO (MyEtherWallet)`) y comprueba de nuevo.',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con Funcoin Wallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde MyEtherWallet. Para conectarte a cualquier nodo, puedes [descargar el repositorio de Funcoin Wallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " por ", // "I want to swap my X ETHO for X BTC"
...
ADD_Ledger_0a               : 'Volver a abrir Funcoin Wallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir Funcoin Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir Funcoin Wallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir Funcoin Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando Funcoin Wallet CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto Funcoin Wallet sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar Funcoin Wallet en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'Funcoin Wallet is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio Funcoin Wallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando Funcoin Wallet, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_2               : 'Si Funcoin Wallet desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de Funcoin Wallet porque no están en MyEtherWallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos Funcoin Wallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si Funcoin Wallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con Funcoin Wallet CX. De este modo, si algo le ocurre a Funcoin Wallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo Funcoin Wallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, Funcoin Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Seguridad - Funcoin Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices Funcoin Wallet en lugar de esta extensión de Chrome. ',
