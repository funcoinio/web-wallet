<div class="block">
      ...
      <article class="cont-md">
        ...
        <p>
          ...
          Once you have a name, you can tell your friends to send FUNC to <code>mewtopia.eth</code> instead of <code>0x7cB57B5A97eAbe942.....</code>.
        </p>
      </article>
      <!-- / ENS Title -->
  ...
  <div ng-hide="showENS()" class="alert alert-danger text-center">
    <p>
      The ENS is only available on the FUNC and Ropsten (Testnet) chains. You are currently on the {{ajaxReq.type}} chain.
      <br />
      Please use the node switcher in the upper right corner to select "FUNC" or "Ropsten".
    </p>
  </div>
  <!-- / IF NOT ENS CHAIN -->
