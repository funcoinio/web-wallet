...
<footer class="footer ng-scope" role="content" aria-label="footer" ng-controller="footerCtrl">
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/funcoinio" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/funcoinio" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
