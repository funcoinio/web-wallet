  ...
  <div class="cont-md">
    ...
    <ul ng-show="ensPrep">
      ...
      <li translate="ENS_Helper_4">
        Decide the maximum amount of FUNC you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that the account has enough to cover your bid + 0.01 FUNC for gas.
      </li>
    </ul>
    ...
    <ul ng-show="ensFinalize">
      ...
      <li translate="ENS_Helper_16">
        The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will be refunded all but 0.01 FUNC.
      </li>
    </ul>
