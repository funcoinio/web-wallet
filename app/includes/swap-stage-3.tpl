        ...
        <section class="row swap-progress">
            ...
            <div class="progress-item {{orderResult.progress.bar[3]}}">
                ...
                <p>
                    ...
                    <small ng-show="orderResult.input.currency=='FUNC'"> Waiting for 10 confirmations...</small>
        ...
        <article class="row" ng-show="showStage3Eth && orderResult.progress.status=='OPEN'">
            ...
            <section class="clearfix collapse-container">
                <div class="text-center" ng-click="wd = !wd">
                    ...
                    <h5 traslate="SWAP_unlock">Unlock your wallet to send FUNC or Tokens directly from this page.</h5>
                </div>
                <div ng-show="!wd">
                    @@if (site === 'mew' ) {
            ...
            <div class="alert alert-danger" ng-show="ajaxReq.type!=='FUNC'">
                ...
                not</strong> support swapping ETC or Testnet FUNC.
            </div>
