  ...
  <article class="row">
    ...
    <section class="col-sm-8">
      ...
      <div ng-show="objENS.status!=ensModes.reveal">
        ...
        <p>
          <small>
            *This is the amount of FUNC you send when placing your bid. It has no bearing on the *actual* amount you bid (above). It is simply to hide your real bid amount. It must be >= to your actual bid.*
          </small>
        </p>
        <div class="input-group">
