    ...
    <div class="col-xs-11">
      <div class="account-help-icon">
        ...
        <p class="account-help-text" translate="x_AddessDesc">
          You may know this as your "Account #" or your "Public Key". It's what you send people so they can send you FUNC. That icon is an easy way to recognize your address.
        </p>
